...
if __name__ == "__main__":
    ...
    for width in widths:
        for dataset_path in opts.datasets:
            costs,centers,_=eval_dataset(dataset_path, width, opts.softmax_temperature, opts)
            np.save(f'AMMDwobj_{opts.decode_strategy}_{21}_{20}_{4}.npy', costs)
            np.save(f'AMMDwcen_{opts.decode_strategy}_{21}_{20}_{4}.npy', centers)
