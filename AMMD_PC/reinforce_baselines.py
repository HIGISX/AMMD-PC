...
class RolloutBaseline(Baseline):
    ...
    def _update_model(self, model, epoch, dataset=None):
        ...
        if dataset is None:
            self.dataset = self.problem.make_dataset(size_d=self.opts.graph_size_d, size_f=self.opts.graph_size_f,
                                                     p=self.opts.p, num_samples=self.opts.val_size,
